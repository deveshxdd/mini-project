...
function Use() {
  return (
    <section id="uses">
      <span className="useTitle">How to Use MediGPT</span>
      <span className="useDecs">
      Using MediGPT is quick and easy. Here's a simple guide to get started:
      </span>
      <div className="useBars">
        ...
        <div className="useBar">
          ...
          <div className="useBarText">
            <h2>Step 3</h2>
            <p>MediGPT will analyze your input and provide relevant medical information and recommendations.</p>
          </div>
        </div>
        <div className="useBar">
          {/* <img src={img3} className="useBarImg"/> */}
        ...
        <div className="useBar">
          ...
          <div className="useBarText">
            <h2>Step 5</h2>
            <p>MediGPT is available 24/7, so you can chat anytime you require medical assistance.</p>
          </div>
        </div>
      </div>
    </section>
